...
namespace UnityEditor.AI
{
    ...
    class NavMeshSurfaceEditor : Editor
    {
        ...
        static UnityEngine.Color s_HandleColor = new UnityEngine.Color(127f, 214f, 244f, 100f) / 255;
        static UnityEngine.Color s_HandleColorSelected = new UnityEngine.Color(127f, 214f, 244f, 210f) / 255;
        static UnityEngine.Color s_HandleColorDisabled = new UnityEngine.Color(127f * 0.75f, 214f * 0.75f, 244f * 0.75f, 100f) / 255;
        ...
        static void RenderBoxGizmo(NavMeshSurface navSurface, GizmoType gizmoType, bool selected)
        {
            ...
            if (navSurface.collectObjects == CollectObjects.Volume)
            {
                ...
                {
                    var colorTrans = new UnityEngine.Color(color.r * 0.75f, color.g * 0.75f, color.b * 0.75f, color.a * 0.15f);
