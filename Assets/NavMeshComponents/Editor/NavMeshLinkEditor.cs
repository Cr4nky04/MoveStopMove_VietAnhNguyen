...
namespace UnityEditor.AI
{
    ...
    class NavMeshLinkEditor : Editor
    {
        ...
        static UnityEngine.Color s_HandleColor = new UnityEngine.Color(255f, 167f, 39f, 210f) / 255;
        static UnityEngine.Color s_HandleColorDisabled = new UnityEngine.Color(255f * 0.75f, 167f * 0.75f, 39f * 0.75f, 100f) / 255;
